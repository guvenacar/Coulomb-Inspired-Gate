...
Section [5](#sec:experiments){reference-type="ref"
...
$$\mathrm{out}(0,G) = b, \qquad \mathrm{out}(1,G) = 1 - b.$$ We verify
this is consistent with Lemma [1](#lem:antisym){reference-type="ref"
...
Lemma [1](#lem:antisym){reference-type="ref" reference="lem:antisym"} is
...
Lemma [1](#lem:antisym){reference-type="ref" reference="lem:antisym"}:
...
-   **Bijective** for every gate pattern, including zero-force patterns
    (Theorem [1](#thm:bij){reference-type="ref" reference="thm:bij"}).
